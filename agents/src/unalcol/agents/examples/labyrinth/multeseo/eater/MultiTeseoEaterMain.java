...
import unalcol.agents.examples.labyrinth.multeseo.eater.SII_2017I.hackermen.HackermenAgent;
...
public class MultiTeseoEaterMain {
    private static SimpleLanguage getLanguage(){
	  ...
	  public static void main( String[] argv ){
	    ...
	    int index1 = 0;
	    int index2 = 1;
	    teseo[index1] = new HackermenAgent( getLanguage() );
	    teseo[index2] = new HackermenAgent( getLanguage() );
