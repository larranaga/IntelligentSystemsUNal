...
import unalcol.agents.examples.games.reversi.Clock;
...
public class Squares extends Environment{
    ...
    protected unalcol.agents.examples.games.squares.Board board = null;
    ...
    public void init(unalcol.agents.examples.games.squares.Board b, Clock c){
        clock = c;
        board = b;
    }
    ...
    public boolean act(Agent agent, Action action){
        ...
        int side = 0;
        if( code[2].equals(LEFT)) side = unalcol.agents.examples.games.squares.Board.LEFT;
        if( code[2].equals(TOP)) side = unalcol.agents.examples.games.squares.Board.TOP;
        if( code[2].equals(RIGHT)) side = unalcol.agents.examples.games.squares.Board.RIGHT;
        if( code[2].equals(BOTTOM)) side = unalcol.agents.examples.games.squares.Board.BOTTOM;
